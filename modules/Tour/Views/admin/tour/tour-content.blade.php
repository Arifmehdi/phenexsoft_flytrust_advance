        ...
        @if(is_default_lang())
            ...
            @if(is_default_lang())
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" name="duration" class="form-control" value="{{old('duration',$row->duration)}}" placeholder="{{__("Duration")}}"  aria-describedby="basic-addon2">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label class="control-label">{{__("Day")}}</label>
                            <div class="input-group mb-3">
                                <input type="number" name="day" class="form-control" value="{{old('day',$row->day)}}" placeholder="{{__("Day")}}"  aria-describedby="basic-addon2">
                                <div class="input-group-append">
