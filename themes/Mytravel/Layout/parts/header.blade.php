                    ...
                    <div class="header-left">
                        <a href="{{url(app_get_locale(false,'/'))}}" class="bravo-logo navbar-brand u-header__navbar-brand-default u-header__navbar-brand-center u-header__navbar-brand-text-white mr-0 mr-xl-5">
                            @if($logo_id = setting_item("logo_id"))
                                ...
                                <img style="width: auto; height:75px;" src="{{asset('uploads/resources/white-logoi.png')}}" alt="{{setting_item("site_title")}}">
                            @endif
                            <span class="u-header__navbar-brand-text d-none">{{ setting_item_with_lang("logo_text") }}</span>
                        </a>
                        <a class="bravo-logo navbar-brand u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-on-scroll" href="{{url(app_get_locale(false,'/'))}}">
                            @if($logo_id = setting_item("logo_id_2"))
                                <?php $logo = get_file_url($logo_id,'full') ?>
                                {{--<img style="width: auto; height:57px;" src="{{$logo}}" alt="{{setting_item("site_title")}}">--}}
                                <img style="width: auto; height:90px;" src="{{asset('uploads/resources/flytrust_white.png')}}" alt="{{setting_item("site_title")}}">
                            @endif
                            <span class="u-header__navbar-brand-text d-none">{{ setting_item_with_lang("logo_text") }}</span>
                        </a>
