...
Tour Packages
bg img
/home/cosqbdco/public_html/themes/Mytravel/Template/Views/frontend/blocks/list-all-service/style_2.blade.php
-->
<div class="bravo-list-all-service tabs-block tab-v1" 
        style="background-image: url('uploads/0000/6/2024/12/12/bg-book-your-hotel.jpg') !important"
        >
    <div class="container space-1">
                    ...
                    <div class="tab-pane fade @if($number == 0) active show @endif bravo_{{$service_type}}" id="bravo_{{$key_time.$service_type}}-tab" >
                        <div class="row">
                            @foreach($rows[$service_type] as $row)
                                <div class="col-md-6 col-lg-3 col-xl-3 mb-3 mb-md-3 pb-1">
        ...
        <div class="tab-content" >
            <div class="w-md-80 w-lg-50 text-center mx-md-auto my-3">
                <h4 class="text-black font-weight-bold mb-0"><a href="/tour"> View All </a></h4>
            </div>
        </div>
    </div>
</div>