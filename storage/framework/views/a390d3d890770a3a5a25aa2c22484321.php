...
<?php $__env->startSection('title', 'Flight - FLY Trust'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['slug' => 'Flight','image' => 'bread-bg-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['slug' => 'Flight','image' => 'bread-bg-6']); ?>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            >
              <div class="card-img">
                <img src="<?php echo e(asset('frontend/images/airline-img7.png')); ?>" alt="flight-logo-img" />
              </div>
              <div class="card-body">
            ...
            >
              <div class="card-img">
                <img src="<?php echo e(asset('frontend/images/airline-img8.png')); ?>" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
            ...
            >
              <div class="card-img">
                <img src="<?php echo e(asset('frontend/images/airline-img9.png')); ?>" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
            ...
            >
              <div class="card-img">
                <img src="<?php echo e(asset('frontend/images/airline-img10.png')); ?>" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
            ...
            >
              <div class="card-img">
                <img src="<?php echo e(asset('frontend/images/airline-img11.png')); ?>" alt="flight-logo-img" />
              </div>
              <div class="card-body">
                <div class="card-top-title d-flex justify-content-between">
                  <div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\resources\views/website/flight.blade.php ENDPATH**/ ?>