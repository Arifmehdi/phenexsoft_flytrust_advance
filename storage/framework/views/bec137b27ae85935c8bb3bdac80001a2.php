    ...
    <ul class="list-group list-group-borderless list-group-horizontal row">
        <?php if($row->duration): ?>
            <li class="col-md-4 flex-horizontal-center list-group-item text-lh-sm mb-2 border-0">
                ...
                <div class="ml-1 text-gray-1"> <?php echo e($row->day ? $row->day.' days,' : ''); ?> <?php echo e(duration_format($row->duration,true)); ?></div>
            </li>
        <?php endif; ?>
        <?php if($row->duration): ?>
            <li class="col-md-4 flex-horizontal-center list-group-item text-lh-sm mb-2 border-0">
...
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\themes/Mytravel/Tour/Views/frontend/layouts/details/tour-detail.blade.php ENDPATH**/ ?>