...
<?php $__env->startSection('title', 'Visa - FLY Trust'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['slug' => 'Visa','image' => 'bread-bg-7']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['slug' => 'Visa','image' => 'bread-bg-7']); ?>
        ...
        <div class="row">
            ...
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/dhubai.jpg')); ?>" alt="hotel-img" />
                </a>
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/singapore-fl.jpg')); ?>" alt="hotel-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/thailand-fl.jpg')); ?>" alt="hotel-img" />
                </a>
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/chaina-1.jpg')); ?>" alt="hotel-img" />
                </a>
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/malaysia-flag.jpg')); ?>" alt="hotel-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/nepal.jpg')); ?>" alt="hotel-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/indronisia-fl.jpg')); ?>" alt="hotel-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
          ...
          <div class="col-lg-4 responsive-column">
            <div class="card-item">
              <div class="card-img">
                <a href="hotel-single.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/visa/turkey.jpg')); ?>" alt="hotel-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\resources\views/website/visa.blade.php ENDPATH**/ ?>