...
<div class="card transition-3d-hover shadow-hover-2 item-loop h-100 <?php echo e($wrap_class ?? ''); ?>">
    ...
    <div class="card-body px-3 py-2">
        ...
        <div class="mb-1 d-flex align-items-center font-size-14 text-gray-1 duration">
            <i class="icon flaticon-clock-circular-outline mr-2 font-size-14"></i> <?php echo e($row->day ? $row->day.' days,' : ''); ?>  <?php echo e(duration_format($row->duration,true)); ?>

        </div>
    </div>
</div>
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\themes/Mytravel/Tour/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>