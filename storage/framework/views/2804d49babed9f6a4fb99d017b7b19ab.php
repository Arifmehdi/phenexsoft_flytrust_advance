    <section class="footer-area section-bg padding-top-100px padding-bottom-30px">
          ...
          <div class="col-lg-3 responsive-column">
            <div class="footer-item">
              <div class="footer-logo padding-bottom-30px">
                <a href="<?php echo e(route('home')); ?>" class="foot__logo"
          ...
          <div class="col-lg-8">
            <div class="term-box footer-item">
              <ul class="list-items list--items d-flex align-items-center">
                ...
                <li><a href="<?php echo e(route('supportpolicy')); ?>">Refund & Cancellation</a></li>
              </ul>
            </div>
          </div>
          <!-- end col-lg-8 -->
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-5">
            ...
            >
              ...
              <img src="<?php echo e(asset('frontend/images/payment-img.png')); ?>" alt="" />
            </div>
      ...
      <!-- end container -->
    </section><?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\resources\views/website/layouts/footer.blade.php ENDPATH**/ ?>