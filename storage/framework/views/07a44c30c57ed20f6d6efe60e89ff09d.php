...
<div class="item-loop relative item-loop-wrap <?php echo e($wrap_class ?? ''); ?>">
    <div class="thumb-image ">
        ...
        <div class="service-wishlist <?php echo e($row->isWishList()); ?> d-none" data-id="<?php echo e($row->id); ?>" data-type="<?php echo e($row->type); ?>">
            <i class="fa fa-heart-o"></i>
        </div>
        <?php if($row->discount_percent): ?>
            <div class="sale_info d-none"><?php echo e($row->discount_percent); ?></div>
        <?php endif; ?>
    ...
    <?php if($row->is_featured == "1"): ?>
        <div class="position-absolute top-0 left-0 pt-3 pl-3 featured d-none">
    ...
    <div class="item-title mt-2 text-center" style="min-height:0px !important; font-size: 18px !important;">
        <a <?php if(!empty($blank)): ?> target="_blank" <?php endif; ?> href="<?php echo e($row->getDetailUrl($include_param ?? true)); ?>">
...
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\themes/Mytravel/Event/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>