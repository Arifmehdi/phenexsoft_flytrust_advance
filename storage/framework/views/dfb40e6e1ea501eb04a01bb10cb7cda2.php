<div class="bravo_topbar u-header__hide-content u-header__topbar u-header__topbar-lg <?php if(!empty($is_home)|| !empty($header_transparent)): ?> <?php else: ?>  border-color-8 <?php endif; ?>"> <!--border-bottom border-color-white-->
           ...
           <!-- phone_contact -->
            <?php if(!empty($phone_contact = setting_item("phone_contact"))): ?>
                   <div class="d-flex align-items-center text-white px-3">
                       <i class="fa fa-mobile fa-lg mr-2 ml-1 font-size-18"></i>
                       <span class="d-inline-block font-size-14 mr-1"><?php echo e($phone_contact); ?></span>
                   </div>
            <?php endif; ?>

            <!-- admin_email -->
            <?php if(!empty($admin_email = setting_item("admin_email"))): ?>

                   <div class="d-flex align-items-center text-white px-3">
                       <i class="fa fa-envelope mr-2 ml-1 font-size-18"></i>
                       <span class="d-inline-block font-size-14 mr-1"><?php echo e($admin_email); ?></span>
                   </div>
            <?php endif; ?>
           <div class="ml-auto d-flex align-items-center">
               
               <div class="list-inline u-header__topbar-nav-divider mb-0 topbar_left_text text-white font-size-14 <?php if(!empty($is_home)|| !empty($header_transparent)): ?> <?php else: ?>  list-inline-dark <?php endif; ?>">
               ...
               <div class="position-relative px-3 u-header__login-form dropdown-connector-xl u-header__topbar-divider">
                   ...
                   <?php else: ?>
                       <div class="d-flex align-items-center text-white py-3 dropdown">
                           <i class="flaticon-user mr-2 ml-1 font-size-18"></i>
                           <span class="d-inline-block font-size-14  text-white mr-1 dropdown-nav-link" data-toggle="dropdown">
                           ...
                           <ul class="dropdown-menu dropdown-menu-user text-left dropdown">
                               ...
                               <?php endif; ?>
                               <?php if(is_vendor()): ?>
                                   <li class="d-none"><a href="<?php echo e(route('vendor.dashboard')); ?>" class=""><i class="icon ion-md-analytics"></i> <?php echo e(__("Vendor Dashboard")); ?></a></li>
                               <?php endif; ?>
                               <?php if(is_admin()): ?>
                                   <li class=""><a href="<?php echo e(url('/admin')); ?>"><i class="icon ion-ios-ribbon"></i> <?php echo e(__("Dashboard")); ?></a></li>
                               <?php endif; ?>
                               ...
                               <?php endif; ?>
                               <li class="d-none"><a href="<?php echo e(route('user.booking_history')); ?>"><i class="fa fa-clock-o"></i> <?php echo e(__("Booking History")); ?></a></li>
...
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\themes/Mytravel/Layout/parts/topbar.blade.php ENDPATH**/ ?>