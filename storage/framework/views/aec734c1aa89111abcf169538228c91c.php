                    ...
                    <div class="header-left">
                        <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="bravo-logo navbar-brand u-header__navbar-brand-default u-header__navbar-brand-center u-header__navbar-brand-text-white mr-0 mr-xl-5">
                            <?php if($logo_id = setting_item("logo_id")): ?>
                                ...
                                <img style="width: auto; height:75px;" src="<?php echo e(asset('uploads/resources/white-logoi.png')); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
                            <?php endif; ?>
                            <span class="u-header__navbar-brand-text d-none"><?php echo e(setting_item_with_lang("logo_text")); ?></span>
                        </a>
                        <a class="bravo-logo navbar-brand u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-on-scroll" href="<?php echo e(url(app_get_locale(false,'/'))); ?>">
                            <?php if($logo_id = setting_item("logo_id_2")): ?>
                                ...
                                <img style="width: auto; height:90px;" src="<?php echo e(asset('uploads/resources/flytrust_white.png')); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
                            <?php endif; ?>
                            <span class="u-header__navbar-brand-text d-none"><?php echo e(setting_item_with_lang("logo_text")); ?></span>
                        </a>
...
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\themes/Mytravel/Layout/parts/header.blade.php ENDPATH**/ ?>