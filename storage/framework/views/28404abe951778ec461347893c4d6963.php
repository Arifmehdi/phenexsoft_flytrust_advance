	...
	<div class="mb-4">
		<div class="input-group border-bottom-1 py-2">
			...
			<div class="smart-search border-0 p-0 form-control  height-40  bg-transparent">
				<input type="text" class="smart-search-location parent_text  font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0 " <?php echo e(( empty(setting_item("flight_location_search_style")) or setting_item("flight_location_search_style") == "normal" ) ? "" : ""); ?> placeholder="<?php echo e(__("Where are you going 08?")); ?>" value="<?php echo e($location_name); ?>" data-onLoad="<?php echo e(__("Loading...")); ?>"
...
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\themes/Mytravel/Flight/Views/frontend/layouts/search/fields/location.blade.php ENDPATH**/ ?>