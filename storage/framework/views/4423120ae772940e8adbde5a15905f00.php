...
<?php $__env->startSection('title', 'Tour - FLY Trust'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['slug' => 'Tour','image' => 'bread-bg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['slug' => 'Tour','image' => 'bread-bg']); ?>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/img9.jpg')); ?>" alt="Destination-img" />
                </a>
                <div
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/img10.jpg')); ?>" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/img11.jpg')); ?>" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/img12.jpg')); ?>" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/img13.jpg')); ?>" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
            ...
            <div class="card-item card-item-list">
              <div class="card-img">
                <a href="tour-details.html" class="d-block">
                  <img src="<?php echo e(asset('frontend/images/img14.jpg')); ?>" alt="Destination-img" />
                </a>
                <div
                  class="add-to-wishlist icon-element"
                  data-bs-toggle="tooltip"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('website.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\resources\views/website/tour.blade.php ENDPATH**/ ?>