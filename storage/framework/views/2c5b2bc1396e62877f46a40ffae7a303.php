    ...
    <div class="effect ">
        <div class="owl-carousel">
            ...
            <?php $__currentLoopData = $list_slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="item position-relative" style="background-image:url('<?php echo e($img); ?>') !important">
                    <div class="effect-bg position-absolute top-0 left-0 right-0 bottom-0 z-0" style=""></div>
    ...
    <div class="container space-2 space-top-xl-4 z-index-2 position-relative">
        <?php if(empty($hide_form_search)): ?>
            <div class="mb-lg-n1">
                ...
                style="
                margin: auto; background: rgba(0, 0, 0, 0.45); 
...
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\themes/Mytravel/Template/Views/frontend/blocks/form-search-all-service/style_slider.blade.php ENDPATH**/ ?>