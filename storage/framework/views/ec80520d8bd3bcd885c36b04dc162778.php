...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(asset('frontend/images/favicon.png')); ?>" />
...
================================= -->
    ...
    <script src="<?php echo e(asset('frontend/js/jquery.countTo.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/animated-headline.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/jquery.ripples-min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/js/quantity-input.js')); ?>"></script>
...
<?php /**PATH D:\laragon\laragon\www\flytrust_exclusive\resources\views/website/layouts/master.blade.php ENDPATH**/ ?>